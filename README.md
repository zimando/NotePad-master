...
#### 修改成绿色的底色
![image](https://github.com/zimando/NotePad-master/raw/master/app/src/main/res/drawable/3.png)
##### 在主界面上绿色底色的显示
![image](https://github.com/zimando/NotePad-master/raw/master/app/src/main/res/drawable/4.png)
#### 所有记事修改颜色 并按照颜色排序
